---
title: "Coding for Communication"
image:
...
<span class="dropcap" style="float: left; font-size: 55px; line-height: 1; margin-right: 5px; height: 50px;">B<span style="display: inline; height: 66px;"></span></span>e it at work trying to understand a legacy codebase with minimal documentation or in academia trying to replicate another group's results with *just* the right package versions, barriers quickly spring up to obfuscate the message of what a program is trying to say. This has led me to ask:
